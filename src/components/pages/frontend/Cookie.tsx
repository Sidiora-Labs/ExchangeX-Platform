      ...
      <div className="p-4 bg-white border border-gray-200 rounded-xl shadow-xs dark:bg-neutral-900 dark:border-neutral-800">
        <div className="flex gap-x-4">
          ...
          <p className="text-sm text-gray-800 dark:text-neutral-200">
            ...
            <Link
              className="inline-flex items-center gap-x-1.5 text-primary-500 decoration-2 hover:underline font-medium dark:text-primary-500"
              href="/cookies"
            >
              {t("Cookies Policy")}
            </Link>
          ...
          <div>
            <button
              type="button"
              className="p-2 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700"
