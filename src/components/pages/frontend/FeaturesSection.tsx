  ...
  const features = [
    {
      ...
      icon: (
        <svg
          className="shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-primary-500 text-muted-800 dark:hs-tab-active:text-primary-500 dark:text-muted-200"
    ...
    <section className="w-full px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto dark:bg-black bg-white dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative">
      ...
      <div className="max-w-7xl relative p-6 md:p-16 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            >
              {features.map((feature, index) => (
                <motion.button
                  ...
                  className={`${
                    activeFeature === index
                      ? "bg-black shadow-md border-transparent dark:bg-black"
                      : "hover:bg-muted-950 dark:hover:bg-black"
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-primary-500 text-muted-800 dark:hs-tab-active:text-primary-500 dark:text-muted-200">
                        {feature.title}
                      </span>
        ...
        <div className="absolute inset-0 grid grid-cols-12 size-full">
          <div className="col-span-full lg:col-span-7 lg:col-start-6 bg-black w-full h-5/6 rounded-xl sm:h-3/4 lg:h-full dark:bg-black"></div>
        </div>
      </div>
    </section>
  );
