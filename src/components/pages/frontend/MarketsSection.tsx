...
const MarketsSection = () => {
  return (
    <section className="w-full px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto dark:bg-black bg-white dark:bg-dot-black/[0.1] bg-dot-black/[0.1] relative">
      ...
      <div className="max-w-13x2 relative pt-6 lg:pt-0 px-0 mx-auto">
        <TrendingMarkets />
      </div>
    </section>
  );
