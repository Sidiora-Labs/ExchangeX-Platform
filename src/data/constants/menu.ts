...
export const userMenu: IMenu[] = [
    ...
    menu: [
      {
        ...
        href: "/user/forex",
        icon: "solar:chart-2-bold-duotone",
        description: "Trade crypto assets with advanced tools",
      },
      {
        title: "Investment Plans",
        href: "/user/forex/plan",
      ...
      },
      {
        ...
        href: "/user/forex",
        icon: "mdi:chart-line",
        description: "Predict price movements with binary options",
      },
    ],
  },
  {
  ...
  {
    title: "Perpetual",
    href: "https://perps.paxeer.app/",
    icon: "material-symbols-light:p2p-outline",
    description: "Trade Perpetual Contracts.",
  },
  {
    title: "Launchpad",
    href: "https://ocfstudio.com",
    icon: "solar:dollar-minimalistic-line-duotone",
    description: "Invest in projects early.",
  },
  {
    title: "Blog",
    href: "/blog",
